...
import cn.richinfo.volley.VolleyLog.MarkerLog;
...
public abstract class Request<T> implements Comparable<Request<T>> {
     ...
     *
     * @deprecated Use {@link #Request(int, String, cn.richinfo.volley.Response.ErrorListener)}.
     */
    @Deprecated
     ...
     * add by ouyangjinfu
     * Creates a new request with the given method (one of the values from {@link Method}),
     * URL, isForceDataNet, and error listener. Note if isForceDataNet is true, the request will use
     ...
     * @param listener
     */
    public Request(int method, String url, boolean isForceDataNet, Response.ErrorListener listener) {
        mMethod = method;
        mUrl = url;
        mIdentifier = createIdentifier(method, url);
        mErrorListener = listener;
    ...
    /**
     * @return this request's {@link cn.richinfo.volley.Response.ErrorListener}.
     */
