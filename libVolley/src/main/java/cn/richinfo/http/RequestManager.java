...
import cn.richinfo.volley.RequestQueue;
import cn.richinfo.volley.RetryPolicy;
import cn.richinfo.volley.VolleyLog;
import cn.richinfo.volley.toolbox.HttpStack;
import cn.richinfo.volley.toolbox.HurlStack;
import cn.richinfo.volley.toolbox.Volley;
...
//		initHttpsHostnameVerifier();
	...
	public LoadControler get(String url, Map<String, String> headers, RequestListener requestListener, boolean shouldCache,boolean isForceDataNet , String actionId) {
		return request(Method.GET, url, null, headers, requestListener, shouldCache, TIMEOUT_COUNT, RETRY_TIMES, isForceDataNet, actionId);
	}
	...
	public LoadControler post(final String url, Object data, Map<String,String> headers,final RequestListener requestListener, boolean shouldCache,
		...
		return request(Method.POST, url, data, headers, requestListener, shouldCache, timeoutCount, retryTimes, isForceDataNet, actionId);
	}
...
//				}
	...
	protected LoadControler sendRequest(int method, final String url, Object data, final Map<String, String> headers,
		...
		if (data != null && data instanceof RequestMap) {// force POST and No  Cache
			request = new ByteArrayRequest(Method.POST, url, data, isForceDataNet, loadControler, loadControler);
